...
assert.ok(js.includes("QuoteQuick Pro"), "missing QuoteQuick Pro");
assert.ok(js.includes("detectFlags"), "missing detectFlags");
assert.ok(js.includes("exportCsv"), "missing exportCsv");
console.log("quotequick-pro smoke checks passed");
