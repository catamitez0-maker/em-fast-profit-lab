...
assert.ok(html.includes("Generate Monitor"), "missing generate action");
...
assert.ok(js.includes("AI Search Presence Monitor"), "missing app name");
assert.ok(js.includes("csvToRows"), "missing CSV parser");
assert.ok(js.includes("exportCsv"), "missing CSV export");
console.log("ai-search-presence-monitor smoke checks passed");
