...
assert.ok(js.includes("MenuMargin Lab"), "missing MenuMargin Lab");
assert.ok(js.includes("parseCsv"), "missing parseCsv");
assert.ok(js.includes("exportCsv"), "missing exportCsv");
console.log("menu-margin-lab smoke checks passed");
