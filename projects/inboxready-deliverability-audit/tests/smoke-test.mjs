...
assert.ok(html.includes("Generate Audit"), "missing generate action");
...
assert.ok(js.includes("InboxReady Deliverability Audit"), "missing app name");
assert.ok(js.includes("csvRecords"), "missing shared CSV record parser");
assert.ok(js.includes("exportCsv"), "missing CSV export");
console.log("inboxready-deliverability-audit smoke checks passed");
