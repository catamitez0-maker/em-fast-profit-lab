...
assert.ok(html.includes("Run QA"), "missing QA action");
...
assert.ok(js.includes("SupportBot QA Harness"), "missing app name");
assert.ok(js.includes("csvToRows"), "missing CSV parser");
assert.ok(js.includes("exportCsv"), "missing CSV export");
console.log("supportbot-qa-harness smoke checks passed");
